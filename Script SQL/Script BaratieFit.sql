...
create database db_baratiefit_2027;

#Ativa o uso do database do produto
use db_baratiefit_2027;
...
-- Cria a tabela de refeicao relacionada com restricao
...
(
    ...
    "Dificuldade na digestão da lactose devido à deficiência da enzima lactase."
),
(
    "Doença Celíaca",
    "Condição autoimune desencadeada pela ingestão de glúten."
),
(
    "Alergia ao Leite",
    "Reação imunológica às proteínas presentes no leite."
),
(
    "Alergia ao Ovo",
    "Reação alérgica causada pelo consumo de ovos."
),
(
    "Alergia ao Amendoim",
    "Reação alérgica provocada pelo consumo de amendoim."
),
(
    "Alergia a Frutos do Mar",
    "Reação alérgica causada pelo consumo de crustáceos e moluscos."
),
(
    "Hipertensão",
    "Necessidade de controle da ingestão de sódio."
),
(
    "Diabetes",
    "Necessidade de controle da ingestão de carboidratos e açúcares."
);
...
(
    "Carboidrato Simples",
    "Carboidratos de rápida absorção que fornecem energia imediata."
),
(
    "Carboidrato Complexo",
    "Carboidratos de absorção lenta, ricos em fibras e energia sustentada."
),
(
    "Proteína Animal",
...
(
    "Legumes",
    "Vegetais geralmente consumidos cozidos ou refogados."
),
(
    "Verduras",
    "Vegetais folhosos ricos em vitaminas e minerais."
),
(
    "Frutas",
    "Fontes naturais de vitaminas, minerais e fibras."
),
(
    "Oleaginosas",
    "Castanhas, amêndoas e sementes ricas em gorduras saudáveis."
),
(
    "Laticínios",
...
(
    "Bebidas",
    "Líquidos destinados ao consumo alimentar."
),
(
    "Temperos e Condimentos",
    "Ingredientes utilizados para saborizar preparações."
);
